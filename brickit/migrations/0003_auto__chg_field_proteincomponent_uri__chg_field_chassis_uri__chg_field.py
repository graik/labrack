...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProteinComponent.uri'
        db.alter_column('brickit_proteincomponent', 'uri', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Chassis.uri'
        db.alter_column('brickit_chassis', 'uri', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'DnaComponent.uri'
        db.alter_column('brickit_dnacomponent', 'uri', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'ProteinComponent.uri'
        db.alter_column('brickit_proteincomponent', 'uri', self.gf('django.db.models.fields.URLField')(default=None, max_length=200))

        # Changing field 'Chassis.uri'
        db.alter_column('brickit_chassis', 'uri', self.gf('django.db.models.fields.URLField')(default=None, max_length=200))

        # Changing field 'DnaComponent.uri'
        db.alter_column('brickit_dnacomponent', 'uri', self.gf('django.db.models.fields.URLField')(default=None, max_length=200))
