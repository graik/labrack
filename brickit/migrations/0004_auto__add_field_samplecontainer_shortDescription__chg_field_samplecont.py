...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SampleContainer.shortDescription'
        db.add_column('brickit_samplecontainer', 'shortDescription', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Changing field 'SampleContainer.description'
        db.alter_column('brickit_samplecontainer', 'description', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Deleting field 'SampleContainer.shortDescription'
        db.delete_column('brickit_samplecontainer', 'shortDescription')

        # Changing field 'SampleContainer.description'
        db.alter_column('brickit_samplecontainer', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))
