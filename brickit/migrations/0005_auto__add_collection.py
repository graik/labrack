...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('brickit_collection', (
        ...
        db.send_create_signal('brickit', ['Collection'])

        # Adding M2M table for field dnaComponents on 'Collection'
        db.create_table('brickit_collection_dnaComponents', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collection', models.ForeignKey(orm['brickit.collection'], null=False)),
            ('dnacomponent', models.ForeignKey(orm['brickit.dnacomponent'], null=False))
        ))
        db.create_unique('brickit_collection_dnaComponents', ['collection_id', 'dnacomponent_id'])

        # Adding M2M table for field proteinComponents on 'Collection'
        db.create_table('brickit_collection_proteinComponents', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collection', models.ForeignKey(orm['brickit.collection'], null=False)),
            ('proteincomponent', models.ForeignKey(orm['brickit.proteincomponent'], null=False))
        ))
        db.create_unique('brickit_collection_proteinComponents', ['collection_id', 'proteincomponent_id'])

        # Adding M2M table for field chassis on 'Collection'
        db.create_table('brickit_collection_chassis', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collection', models.ForeignKey(orm['brickit.collection'], null=False)),
            ('chassis', models.ForeignKey(orm['brickit.chassis'], null=False))
        ))
        db.create_unique('brickit_collection_chassis', ['collection_id', 'chassis_id'])


    def backwards(self, orm):
        
        # Deleting model 'Collection'
        db.delete_table('brickit_collection')

        # Removing M2M table for field dnaComponents on 'Collection'
        db.delete_table('brickit_collection_dnaComponents')

        # Removing M2M table for field proteinComponents on 'Collection'
        db.delete_table('brickit_collection_proteinComponents')

        # Removing M2M table for field chassis on 'Collection'
        db.delete_table('brickit_collection_chassis')
