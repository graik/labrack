...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('brickit_sequenceannotation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uri', self.gf('django.db.models.fields.URLField')(max_length=200, unique=True, null=True, blank=True)),
        ...
        db.send_create_signal('brickit', ['SequenceAnnotation'])

        # Adding M2M table for field precedes on 'SequenceAnnotation'
        db.create_table('brickit_sequenceannotation_precedes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_sequenceannotation', models.ForeignKey(orm['brickit.sequenceannotation'], null=False)),
            ('to_sequenceannotation', models.ForeignKey(orm['brickit.sequenceannotation'], null=False))
        ))
        db.create_unique('brickit_sequenceannotation_precedes', ['from_sequenceannotation_id', 'to_sequenceannotation_id'])

        # Adding M2M table for field annotations on 'ProteinComponent'
        db.create_table('brickit_proteincomponent_annotations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('proteincomponent', models.ForeignKey(orm['brickit.proteincomponent'], null=False)),
            ('sequenceannotation', models.ForeignKey(orm['brickit.sequenceannotation'], null=False))
        ))
        db.create_unique('brickit_proteincomponent_annotations', ['proteincomponent_id', 'sequenceannotation_id'])

        # Adding M2M table for field annotations on 'Chassis'
        db.create_table('brickit_chassis_annotations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('chassis', models.ForeignKey(orm['brickit.chassis'], null=False)),
            ('sequenceannotation', models.ForeignKey(orm['brickit.sequenceannotation'], null=False))
        ))
        db.create_unique('brickit_chassis_annotations', ['chassis_id', 'sequenceannotation_id'])

        # Adding M2M table for field annotations on 'DnaComponent'
        db.create_table('brickit_dnacomponent_annotations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dnacomponent', models.ForeignKey(orm['brickit.dnacomponent'], null=False)),
            ('sequenceannotation', models.ForeignKey(orm['brickit.sequenceannotation'], null=False))
        ))
        db.create_unique('brickit_dnacomponent_annotations', ['dnacomponent_id', 'sequenceannotation_id'])


    def backwards(self, orm):
        
        # Deleting model 'SequenceAnnotation'
        db.delete_table('brickit_sequenceannotation')

        # Removing M2M table for field precedes on 'SequenceAnnotation'
        db.delete_table('brickit_sequenceannotation_precedes')

        # Removing M2M table for field annotations on 'ProteinComponent'
        db.delete_table('brickit_proteincomponent_annotations')

        # Removing M2M table for field annotations on 'Chassis'
        db.delete_table('brickit_chassis_annotations')

        # Removing M2M table for field annotations on 'DnaComponent'
        db.delete_table('brickit_dnacomponent_annotations')
