...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Sample.wellType'
        db.delete_column('brickit_sample', 'wellType')

        # Adding field 'Sample.vessel'
        db.add_column('brickit_sample', 'vessel', self.gf('django.db.models.fields.CharField')(default='tube', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Sample.wellType'
        db.add_column('brickit_sample', 'wellType', self.gf('django.db.models.fields.CharField')(default='tube', max_length=30), keep_default=False)

        # Deleting field 'Sample.vessel'
        db.delete_column('brickit_sample', 'vessel')
    ...
    models = {
        ...
        'brickit.sample': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'db_index': 'True', 'symmetrical': 'False'}),
            'vessel': ('django.db.models.fields.CharField', [], {'default': "'tube'", 'max_length': '30'})
        },
