...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('brickit_sample', 'vesselType', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=30), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('brickit_sample', 'vesselType')
    ...
    models = {
        ...
        'brickit.sample': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'db_index': 'True', 'symmetrical': 'False'}),
            'vesselType': ('django.db.models.fields.CharField', [], {'default': "'unknown'", 'max_length': '30'})
        },
