...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sample.vesselType'
        db.alter_column('brickit_sample', 'vesselType', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Adding field 'ProteinComponent.status'
        db.add_column('brickit_proteincomponent', 'status', self.gf('django.db.models.fields.CharField')(default='planning', max_length=30), keep_default=False)

        # Adding field 'Chassis.status'
        db.add_column('brickit_chassis', 'status', self.gf('django.db.models.fields.CharField')(default='planning', max_length=30), keep_default=False)

        # Adding field 'DnaComponent.status'
        db.add_column('brickit_dnacomponent', 'status', self.gf('django.db.models.fields.CharField')(default='planning', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Sample.vesselType'
        db.alter_column('brickit_sample', 'vesselType', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Deleting field 'ProteinComponent.status'
        db.delete_column('brickit_proteincomponent', 'status')

        # Deleting field 'Chassis.status'
        db.delete_column('brickit_chassis', 'status')

        # Deleting field 'DnaComponent.status'
        db.delete_column('brickit_dnacomponent', 'status')
    ...
    models = {
        ...
        'brickit.sample': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'db_index': 'True', 'symmetrical': 'False'}),
            'vesselType': ('django.db.models.fields.CharField', [], {'default': "'unknown'", 'max_length': '30', 'null': 'True', 'blank': 'True'})
        },
