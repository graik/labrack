...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ComponentType', fields ['uri']
        db.delete_unique('brickit_componenttype', ['uri'])

        # Removing unique constraint on 'SequenceAnnotation', fields ['uri']
        db.delete_unique('brickit_sequenceannotation', ['uri'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'SequenceAnnotation', fields ['uri']
        db.create_unique('brickit_sequenceannotation', ['uri'])

        # Adding unique constraint on 'ComponentType', fields ['uri']
        db.create_unique('brickit_componenttype', ['uri'])
