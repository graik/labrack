...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sample.shortDescription'
        db.add_column('labrack_sample', 'shortDescription',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sample.shortDescription'
        db.delete_column('labrack_sample', 'shortDescription')
