...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Component.registration_date'
        db.add_column('labrack_component', 'registration_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 8, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Component.registration_date'
        db.delete_column('labrack_component', 'registration_date')
