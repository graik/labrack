...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('labrack_container', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='container_created_by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Adding field 'Project.created_by'
        db.add_column('labrack_project', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_created_by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Adding field 'Sample.created_by'
        db.add_column('labrack_sample', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sample_created_by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)
