...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SampleContent.content_type'
        db.add_column('labrack_samplecontent', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'SampleContent.object_id'
        db.add_column('labrack_samplecontent', 'object_id',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'SampleContent.contentType'
        raise RuntimeError("Cannot reverse this migration. 'SampleContent.contentType' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'SampleContent.objectId'
        raise RuntimeError("Cannot reverse this migration. 'SampleContent.objectId' and its values cannot be restored.")
