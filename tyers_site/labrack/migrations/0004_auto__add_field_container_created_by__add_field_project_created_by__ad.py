...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Container.created_by'
        db.add_column('labrack_container', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='container_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Project.created_by'
        db.add_column('labrack_project', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='project_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Sample.created_by'
        db.add_column('labrack_sample', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sample_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Component.created_by'
        db.add_column('labrack_component', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='component_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Container.created_by'
        db.delete_column('labrack_container', 'created_by_id')

        # Deleting field 'Project.created_by'
        db.delete_column('labrack_project', 'created_by_id')

        # Deleting field 'Sample.created_by'
        db.delete_column('labrack_sample', 'created_by_id')

        # Deleting field 'Component.created_by'
        db.delete_column('labrack_component', 'created_by_id')
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 17, 0, 0)'}),
