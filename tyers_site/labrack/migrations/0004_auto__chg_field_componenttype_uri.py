...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ComponentType.uri'
        db.alter_column('labrack_componenttype', 'uri', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ComponentType.uri'
        raise RuntimeError("Cannot reverse this migration. 'ComponentType.uri' and its values cannot be restored.")
