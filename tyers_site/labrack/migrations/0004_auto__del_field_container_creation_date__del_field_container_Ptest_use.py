...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Container.creation_date'
        db.delete_column('labrack_container', 'creation_date')

        # Deleting field 'Container.Ptest_user'
        db.delete_column('labrack_container', 'Ptest_user_id')

        # Deleting field 'Container.modification_date'
        db.delete_column('labrack_container', 'modification_date')

        # Deleting field 'Rack.creation_date'
        db.delete_column('labrack_rack', 'creation_date')

        # Deleting field 'Rack.Ptest_user'
        db.delete_column('labrack_rack', 'Ptest_user_id')

        # Deleting field 'Rack.modification_date'
        db.delete_column('labrack_rack', 'modification_date')

        # Deleting field 'Component.creation_date'
        db.delete_column('labrack_component', 'creation_date')

        # Deleting field 'Component.Ptest_user'
        db.delete_column('labrack_component', 'Ptest_user_id')

        # Deleting field 'Component.modification_date'
        db.delete_column('labrack_component', 'modification_date')

        # Deleting field 'Location.creation_date'
        db.delete_column('labrack_location', 'creation_date')

        # Deleting field 'Location.Ptest_user'
        db.delete_column('labrack_location', 'Ptest_user_id')

        # Deleting field 'Location.modification_date'
        db.delete_column('labrack_location', 'modification_date')

        # Deleting field 'SampleCollection.Ptest_user'
        db.delete_column('labrack_samplecollection', 'Ptest_user_id')

        # Deleting field 'SampleCollection.modification_date'
        db.delete_column('labrack_samplecollection', 'modification_date')

        # Deleting field 'SampleCollection.creation_date'
        db.delete_column('labrack_samplecollection', 'creation_date')

        # Deleting field 'Sample.creation_date'
        db.delete_column('labrack_sample', 'creation_date')

        # Deleting field 'Sample.modification_date'
        db.delete_column('labrack_sample', 'modification_date')

        # Deleting field 'Sample.Ptest_user'
        db.delete_column('labrack_sample', 'Ptest_user_id')


    def backwards(self, orm):
        # Adding field 'Container.creation_date'
        db.add_column('labrack_container', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Container.Ptest_user'
        db.add_column('labrack_container', 'Ptest_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Container.modification_date'
        db.add_column('labrack_container', 'modification_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Rack.creation_date'
        db.add_column('labrack_rack', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Rack.Ptest_user'
        db.add_column('labrack_rack', 'Ptest_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Rack.modification_date'
        db.add_column('labrack_rack', 'modification_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Component.creation_date'
        db.add_column('labrack_component', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Component.Ptest_user'
        db.add_column('labrack_component', 'Ptest_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Component.modification_date'
        db.add_column('labrack_component', 'modification_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.creation_date'
        db.add_column('labrack_location', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.Ptest_user'
        db.add_column('labrack_location', 'Ptest_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.modification_date'
        db.add_column('labrack_location', 'modification_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleCollection.Ptest_user'
        db.add_column('labrack_samplecollection', 'Ptest_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleCollection.modification_date'
        db.add_column('labrack_samplecollection', 'modification_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleCollection.creation_date'
        db.add_column('labrack_samplecollection', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sample.creation_date'
        db.add_column('labrack_sample', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sample.modification_date'
        db.add_column('labrack_sample', 'modification_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sample.Ptest_user'
        db.add_column('labrack_sample', 'Ptest_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'labrack.component': {
            ...
            'registration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 8, 0, 0)'}),
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 8, 0, 0)'}),
