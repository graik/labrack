...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Container.registration_date'
        db.add_column('labrack_container', 'registration_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 8, 0, 0)),
                      keep_default=False)

        # Adding field 'Rack.registration_date'
        db.add_column('labrack_rack', 'registration_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 8, 0, 0)),
                      keep_default=False)

        # Adding field 'Location.registration_date'
        db.add_column('labrack_location', 'registration_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 8, 0, 0)),
                      keep_default=False)


        # Changing field 'ChassisSample.chassis'
        db.alter_column('labrack_chassissample', 'chassis_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['labrack.Chassis']))

    def backwards(self, orm):
        # Deleting field 'Container.registration_date'
        db.delete_column('labrack_container', 'registration_date')

        # Deleting field 'Rack.registration_date'
        db.delete_column('labrack_rack', 'registration_date')

        # Deleting field 'Location.registration_date'
        db.delete_column('labrack_location', 'registration_date')


        # Changing field 'ChassisSample.chassis'
        db.alter_column('labrack_chassissample', 'chassis_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['labrack.Chassis']))
