...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BlogEntryRelation.displayId'
        db.delete_column('labrack_blogentryrelation', 'displayId')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'BlogEntryRelation.displayId'
        db.add_column('labrack_blogentryrelation', 'displayId',
    ...
    models = {
        ...
        'labrack.samplecomponentrelation': {
            'Meta': {'object_name': 'SampleComponentRelation'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
