...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sample on 'Sample'
        db.create_table('labrack_sample_sample', (
        ...
        db.create_unique('labrack_sample_sample', ['sample_id', 'samplecollection_id'])
    ...
    def backwards(self, orm):
        # Removing M2M table for field sample on 'Sample'
        db.delete_table('labrack_sample_sample')
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'sample': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['labrack.SampleCollection']", 'null': 'True', 'blank': 'True'}),
