...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('labrack_samplepedigree', (
            ('sample', self.gf('django.db.models.fields.related.ForeignKey')(related_name='samplepedigree', to=orm['labrack.Sample'])),
            ('amount', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('concentrationUnit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='samplepedigree_concentration_unit', null=True, to=orm['labrack.Unit'], blank=True)),
            ('concentration', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('sample_source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='samplesource', null=True, to=orm['labrack.Sample'])),
            ('amountUnit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='samplepedigree_amount_unit', null=True, to=orm['labrack.Unit'], blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
