...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleContent.solvent'
        db.add_column('labrack_samplecontent', 'solvent',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SampleContent.solvent'
        db.delete_column('labrack_samplecontent', 'solvent')
    ...
    models = {
        ...
        'labrack.samplecontent': {
            ...
            'solvent': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
