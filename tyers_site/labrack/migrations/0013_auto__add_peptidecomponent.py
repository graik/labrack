...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('labrack_peptidecomponent', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='peptidecomponent_created_by', null=True, to=orm['auth.User'])),
            ('sequence', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('labrack', ['PeptideComponent'])

        # Adding M2M table for field componentClassification on 'PeptideComponent'
        db.create_table('labrack_peptidecomponent_componentClassification', (
        ...
        db.create_unique('labrack_peptidecomponent_componentClassification', ['peptidecomponent_id', 'componentclassification_id'])

        # Adding M2M table for field variantOf on 'PeptideComponent'
        db.create_table('labrack_peptidecomponent_variantOf', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique('labrack_peptidecomponent_variantOf', ['from_peptidecomponent_id', 'to_peptidecomponent_id'])

        # Adding M2M table for field annotations on 'PeptideComponent'
        db.create_table('labrack_peptidecomponent_annotations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('peptidecomponent', models.ForeignKey(orm['labrack.peptidecomponent'], null=False)),
            ('sequenceannotation', models.ForeignKey(orm['labrack.sequenceannotation'], null=False))
        ))
        db.create_unique('labrack_peptidecomponent_annotations', ['peptidecomponent_id', 'sequenceannotation_id'])

        # Adding M2M table for field owners on 'PeptideComponent'
        db.create_table('labrack_peptidecomponent_owners', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('peptidecomponent', models.ForeignKey(orm['labrack.peptidecomponent'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('labrack_peptidecomponent_owners', ['peptidecomponent_id', 'user_id'])

        # Adding M2M table for field group_read on 'PeptideComponent'
        db.create_table('labrack_peptidecomponent_group_read', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('peptidecomponent', models.ForeignKey(orm['labrack.peptidecomponent'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('labrack_peptidecomponent_group_read', ['peptidecomponent_id', 'group_id'])

        # Adding M2M table for field group_write on 'PeptideComponent'
        db.create_table('labrack_peptidecomponent_group_write', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('peptidecomponent', models.ForeignKey(orm['labrack.peptidecomponent'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('labrack_peptidecomponent_group_write', ['peptidecomponent_id', 'group_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field componentClassification on 'PeptideComponent'
        db.delete_table('labrack_peptidecomponent_componentClassification')

        # Removing M2M table for field variantOf on 'PeptideComponent'
        db.delete_table('labrack_peptidecomponent_variantOf')

        # Removing M2M table for field annotations on 'PeptideComponent'
        db.delete_table('labrack_peptidecomponent_annotations')

        # Removing M2M table for field owners on 'PeptideComponent'
        db.delete_table('labrack_peptidecomponent_owners')

        # Removing M2M table for field group_read on 'PeptideComponent'
        db.delete_table('labrack_peptidecomponent_group_read')

        # Removing M2M table for field group_write on 'PeptideComponent'
        db.delete_table('labrack_peptidecomponent_group_write')
