...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SampleContent.solvent'
        db.alter_column('labrack_samplecontent', 'solvent', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'SampleContent.solvent'
        db.alter_column('labrack_samplecontent', 'solvent', self.gf('django.db.models.fields.TextField')())
