...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Container.location'
        db.delete_column('labrack_container', 'location_id')


    def backwards(self, orm):
        # Adding field 'Container.location'
        db.add_column('labrack_container', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='containers', to=orm['labrack.Location']),
                      keep_default=False)
