...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SequenceAnnotation.subComponent'
        db.add_column('labrack_sequenceannotation', 'subComponent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='subComponentOf', to=orm['labrack.Component']),
                      keep_default=False)

        # Adding field 'SequenceAnnotation.componentAnnotated'
        db.add_column('labrack_sequenceannotation', 'componentAnnotated',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='annotatedForComponent', null=True, to=orm['labrack.Component']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SequenceAnnotation.subComponent'
        db.delete_column('labrack_sequenceannotation', 'subComponent_id')

        # Deleting field 'SequenceAnnotation.componentAnnotated'
        db.delete_column('labrack_sequenceannotation', 'componentAnnotated_id')
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 22, 0, 0)'}),
