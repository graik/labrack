...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SamplePedigree.sample_source'
        db.add_column('labrack_samplepedigree', 'sample_source',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['labrack.Sample'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SamplePedigree.sample_source'
        db.delete_column('labrack_samplepedigree', 'sample_source_id')
    ...
    models = {
        ...
        'labrack.samplepedigree': {
            ...
            'sample_source': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['labrack.Sample']", 'unique': 'True', 'null': 'True'})
        },
