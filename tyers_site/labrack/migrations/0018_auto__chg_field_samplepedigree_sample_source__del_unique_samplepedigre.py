...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SamplePedigree', fields ['sample_source']
        db.delete_unique('labrack_samplepedigree', ['sample_source_id'])


        # Changing field 'SamplePedigree.sample_source'
        db.alter_column('labrack_samplepedigree', 'sample_source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labrack.Sample'], null=True))

    def backwards(self, orm):

        # Changing field 'SamplePedigree.sample_source'
        db.alter_column('labrack_samplepedigree', 'sample_source_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['labrack.Sample'], unique=True, null=True))
        # Adding unique constraint on 'SamplePedigree', fields ['sample_source']
        db.create_unique('labrack_samplepedigree', ['sample_source_id'])
