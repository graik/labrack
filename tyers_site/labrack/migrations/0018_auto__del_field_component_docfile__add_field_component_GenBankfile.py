...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Component.docfile'
        db.delete_column('labrack_component', 'docfile')
    ...
    def backwards(self, orm):
        # Adding field 'Component.docfile'
        db.add_column('labrack_component', 'docfile',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 25, 0, 0)'}),
