...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field precedesField on 'SequenceAnnotation'
        db.delete_table('labrack_sequenceannotation_precedesField')
        ...
        # Changing field 'Component.GenBankfile'
        db.alter_column('labrack_component', 'GenBankfile', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):
        # Adding M2M table for field precedesField on 'SequenceAnnotation'
        db.create_table('labrack_sequenceannotation_precedesField', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_sequenceannotation', models.ForeignKey(orm['labrack.sequenceannotation'], null=False)),
            ('to_sequenceannotation', models.ForeignKey(orm['labrack.sequenceannotation'], null=False))
        ))
        db.create_unique('labrack_sequenceannotation_precedesField', ['from_sequenceannotation_id', 'to_sequenceannotation_id'])
        ...
        # Changing field 'Component.GenBankfile'
        db.alter_column('labrack_component', 'GenBankfile', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))
    ...
    models = {
        ...
        'labrack.component': {
            'GenBankfile': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 30, 0, 0)'}),
