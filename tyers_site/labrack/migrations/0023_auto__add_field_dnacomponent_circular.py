...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DnaComponent.circular'
        db.add_column('labrack_dnacomponent', 'circular',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DnaComponent.circular'
        db.delete_column('labrack_dnacomponent', 'circular')
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 13, 0, 0)'}),
