...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleLink.shortDescription'
        db.add_column('labrack_samplelink', 'shortDescription',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SampleLink.shortDescription'
        db.delete_column('labrack_samplelink', 'shortDescription')
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 28, 0, 0)'}),
            'shortDescription': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
