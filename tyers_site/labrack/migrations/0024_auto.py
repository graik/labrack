...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field dnaComponentType on 'DnaComponent'
        db.create_table('labrack_dnacomponent_dnaComponentType', (
        ...
        db.create_unique('labrack_dnacomponent_dnaComponentType', ['dnacomponent_id', 'dnacomponenttype_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field dnaComponentType on 'DnaComponent'
        db.delete_table('labrack_dnacomponent_dnaComponentType')
    ...
    models = {
        ...
        'labrack.dnacomponent': {
            ...
            'component_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['labrack.Component']", 'unique': 'True', 'primary_key': 'True'}),
            'dnaComponentType': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['labrack.DNAComponentType']", 'null': 'True', 'blank': 'True'}),
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 14, 0, 0)'}),
