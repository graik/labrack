...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 29, 0, 0)'}),
            'project': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['labrack.Project']", 'symmetrical': 'False'}),
            'shortDescription': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
