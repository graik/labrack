...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('labrack_samplecontent', (
            ...
            ('concentrationUnit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='concentrationUnit', null=True, to=orm['labrack.Unit'], blank=True)),
            ('concentration', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('amountUnit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='amountUnit', null=True, to=orm['labrack.Unit'], blank=True)),
        ...
        db.create_table('labrack_samplecollection', (
            ...
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='samplecollection_created_by', null=True, to=orm['auth.User'], blank=True)),
        ...
        db.create_table('labrack_sample', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sample_created_by', null=True, to=orm['auth.User'], blank=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
