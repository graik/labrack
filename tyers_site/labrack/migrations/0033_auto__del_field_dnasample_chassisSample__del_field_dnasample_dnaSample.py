...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DnaSample.chassisSample'
        db.delete_column('labrack_dnasample', 'chassisSample_id')

        # Deleting field 'DnaSample.dnaSample'
        db.delete_column('labrack_dnasample', 'dnaSample_id')

        # Adding field 'DnaSample.dnaConstruct'
        db.add_column('labrack_dnasample', 'dnaConstruct',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='dnaSample', to=orm['labrack.DnaComponent']),
                      keep_default=False)

        # Adding field 'DnaSample.inChassis'
        db.add_column('labrack_dnasample', 'inChassis',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='chassisSample', null=True, to=orm['labrack.Chassis']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DnaSample.chassisSample'
        db.add_column('labrack_dnasample', 'chassisSample',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='chassisSample', null=True, to=orm['labrack.Chassis'], blank=True),
                      keep_default=False)

        # Adding field 'DnaSample.dnaSample'
        db.add_column('labrack_dnasample', 'dnaSample',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='dnaSample', to=orm['labrack.DnaComponent']),
                      keep_default=False)

        # Deleting field 'DnaSample.dnaConstruct'
        db.delete_column('labrack_dnasample', 'dnaConstruct_id')

        # Deleting field 'DnaSample.inChassis'
        db.delete_column('labrack_dnasample', 'inChassis_id')
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 27, 0, 0)'}),
