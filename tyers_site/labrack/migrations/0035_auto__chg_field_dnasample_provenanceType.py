...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DnaSample.provenanceType'
        db.alter_column('labrack_dnasample', 'provenanceType', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'DnaSample.provenanceType'
        db.alter_column('labrack_dnasample', 'provenanceType', self.gf('django.db.models.fields.CharField')(max_length=30))
