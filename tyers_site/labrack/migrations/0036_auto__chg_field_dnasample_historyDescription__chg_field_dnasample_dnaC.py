...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DnaSample.historyDescription'
        db.alter_column('labrack_dnasample', 'historyDescription', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'DnaSample.dnaConstruct'
        db.alter_column('labrack_dnasample', 'dnaConstruct_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['labrack.DnaComponent']))

    def backwards(self, orm):

        # Changing field 'DnaSample.historyDescription'
        db.alter_column('labrack_dnasample', 'historyDescription', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'DnaSample.dnaConstruct'
        db.alter_column('labrack_dnasample', 'dnaConstruct_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['labrack.DnaComponent']))
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 2, 0, 0)'}),
