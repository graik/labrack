...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('labrack_chassissample', (
            ...
            ('chassis', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Chassis', to=orm['labrack.Chassis'])),
            ('solvent', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('conc', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('concUnit', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='concU', null=True, to=orm['labrack.Unit'])),
        ))
    ...
    models = {
        ...
        'labrack.chassissample': {
            ...
            'chassis': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'Chassis'", 'to': "orm['labrack.Chassis']"}),
