...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ChassisSample.chassis'
        db.alter_column('labrack_chassissample', 'chassis_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['labrack.Chassis']))
    ...
    models = {
        ...
        'labrack.chassissample': {
            ...
            'chassis': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Chassis'", 'null': 'True', 'to': "orm['labrack.Chassis']"}),
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 3, 0, 0)'}),
