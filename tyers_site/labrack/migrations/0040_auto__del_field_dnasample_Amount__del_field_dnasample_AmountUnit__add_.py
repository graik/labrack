...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('labrack_dnasample', 'amountUnit',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='amounUnit', null=True, to=orm['labrack.Unit']),
                      keep_default=False)
    ...
    models = {
        ...
        'labrack.chassissample': {
            ...
            'conc': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'concUnit': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'concU'", 'null': 'True', 'to': "orm['labrack.Unit']"}),
        ...
        'labrack.dnasample': {
            ...
            'amountUnit': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'amounUnit'", 'null': 'True', 'to': "orm['labrack.Unit']"}),
