...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChassisSample.amount'
        db.delete_column('labrack_chassissample', 'amount')

        # Deleting field 'ChassisSample.solvent'
        db.delete_column('labrack_chassissample', 'solvent')

        # Deleting field 'ChassisSample.concUnit'
        db.delete_column('labrack_chassissample', 'concUnit_id')

        # Deleting field 'ChassisSample.conc'
        db.delete_column('labrack_chassissample', 'conc')

        # Deleting field 'ChassisSample.amountUnit'
        db.delete_column('labrack_chassissample', 'amountUnit_id')

        # Deleting field 'DnaSample.solvent'
        db.delete_column('labrack_dnasample', 'solvent')

        # Deleting field 'DnaSample.concentration'
        db.delete_column('labrack_dnasample', 'concentration')

        # Deleting field 'DnaSample.amountUnit'
        db.delete_column('labrack_dnasample', 'amountUnit_id')

        # Deleting field 'DnaSample.amount'
        db.delete_column('labrack_dnasample', 'amount')

        # Deleting field 'DnaSample.concentrationUnit'
        db.delete_column('labrack_dnasample', 'concentrationUnit_id')

        # Adding field 'Sample.solvent'
        db.add_column('labrack_sample', 'solvent',
        ...
        db.add_column('labrack_sample', 'concentrationUnit',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='concUnit', null=True, to=orm['labrack.Unit']),
                      keep_default=False)

        # Adding field 'Sample.amount'
        db.add_column('labrack_sample', 'amount',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sample.amountUnit'
        db.add_column('labrack_sample', 'amountUnit',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='amouUnit', null=True, to=orm['labrack.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ChassisSample.amount'
        db.add_column('labrack_chassissample', 'amount',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ChassisSample.solvent'
        db.add_column('labrack_chassissample', 'solvent',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ChassisSample.concUnit'
        db.add_column('labrack_chassissample', 'concUnit',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='concU', null=True, to=orm['labrack.Unit'], blank=True),
                      keep_default=False)

        # Adding field 'ChassisSample.conc'
        db.add_column('labrack_chassissample', 'conc',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ChassisSample.amountUnit'
        db.add_column('labrack_chassissample', 'amountUnit',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='amounUnit', null=True, to=orm['labrack.Unit'], blank=True),
                      keep_default=False)

        # Adding field 'DnaSample.solvent'
        db.add_column('labrack_dnasample', 'solvent',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'DnaSample.concentration'
        db.add_column('labrack_dnasample', 'concentration',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DnaSample.amountUnit'
        db.add_column('labrack_dnasample', 'amountUnit',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='amouUnit', null=True, to=orm['labrack.Unit'], blank=True),
                      keep_default=False)

        # Adding field 'DnaSample.amount'
        db.add_column('labrack_dnasample', 'amount',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DnaSample.concentrationUnit'
        db.add_column('labrack_dnasample', 'concentrationUnit',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='concUnit', null=True, to=orm['labrack.Unit'], blank=True),
                      keep_default=False)

        # Deleting field 'Sample.solvent'
        db.delete_column('labrack_sample', 'solvent')

        # Deleting field 'Sample.concentration'
        db.delete_column('labrack_sample', 'concentration')

        # Deleting field 'Sample.concentrationUnit'
        db.delete_column('labrack_sample', 'concentrationUnit_id')

        # Deleting field 'Sample.amount'
        db.delete_column('labrack_sample', 'amount')

        # Deleting field 'Sample.amountUnit'
        db.delete_column('labrack_sample', 'amountUnit_id')
    ...
    models = {
        ...
        'labrack.dnasample': {
            ...
            'historyDescription': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 4, 0, 0)'}),
