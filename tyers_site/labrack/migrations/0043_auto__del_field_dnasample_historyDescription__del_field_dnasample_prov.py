...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DnaSample.historyDescription'
        db.delete_column('labrack_dnasample', 'historyDescription')

        # Deleting field 'DnaSample.provenanceType'
        db.delete_column('labrack_dnasample', 'provenanceType')

        # Deleting field 'DnaSample.derivedFrom'
        db.delete_column('labrack_dnasample', 'derivedFrom_id')

        # Adding field 'Sample.derivedFrom'
        db.add_column('labrack_sample', 'derivedFrom',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='derivedFromSample', null=True, to=orm['labrack.Sample']),
                      keep_default=False)

        # Adding field 'Sample.provenanceType'
        db.add_column('labrack_sample', 'provenanceType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sample.historyDescription'
        db.add_column('labrack_sample', 'historyDescription',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DnaSample.historyDescription'
        db.add_column('labrack_dnasample', 'historyDescription',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DnaSample.provenanceType'
        db.add_column('labrack_dnasample', 'provenanceType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DnaSample.derivedFrom'
        db.add_column('labrack_dnasample', 'derivedFrom',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='derivedFromSample', null=True, to=orm['labrack.DnaSample'], blank=True),
                      keep_default=False)

        # Deleting field 'Sample.derivedFrom'
        db.delete_column('labrack_sample', 'derivedFrom_id')

        # Deleting field 'Sample.provenanceType'
        db.delete_column('labrack_sample', 'provenanceType')

        # Deleting field 'Sample.historyDescription'
        db.delete_column('labrack_sample', 'historyDescription')
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'derivedFrom': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'derivedFromSample'", 'null': 'True', 'to': "orm['labrack.Sample']"}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
