...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Component.GenBankfile'
        db.delete_column('labrack_component', 'GenBankfile')

        # Adding field 'DnaComponent.GenBankfile'
        db.add_column('labrack_dnacomponent', 'GenBankfile',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Component.GenBankfile'
        db.add_column('labrack_component', 'GenBankfile',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DnaComponent.GenBankfile'
        db.delete_column('labrack_dnacomponent', 'GenBankfile')
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 5, 0, 0)'}),
