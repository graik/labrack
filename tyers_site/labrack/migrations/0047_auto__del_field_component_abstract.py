...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Component.abstract'
        db.delete_column('labrack_component', 'abstract')


    def backwards(self, orm):
        # Adding field 'Component.abstract'
        db.add_column('labrack_component', 'abstract',
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 11, 0, 0)'}),
