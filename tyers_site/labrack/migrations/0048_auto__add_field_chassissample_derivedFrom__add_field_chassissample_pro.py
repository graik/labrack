...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChassisSample.derivedFrom'
        db.add_column('labrack_chassissample', 'derivedFrom',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='derivedFromSample', null=True, to=orm['labrack.ChassisSample']),
                      keep_default=False)

        # Adding field 'ChassisSample.provenanceType'
        db.add_column('labrack_chassissample', 'provenanceType',
        ...
        db.add_column('labrack_dnasample', 'derivedFrom',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='derivedFromSample', null=True, to=orm['labrack.DnaSample']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'ChassisSample.derivedFrom'
        db.delete_column('labrack_chassissample', 'derivedFrom_id')

        # Deleting field 'ChassisSample.provenanceType'
        db.delete_column('labrack_chassissample', 'provenanceType')
        ...
        db.add_column('labrack_sample', 'derivedFrom',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='derivedFromSample', null=True, to=orm['labrack.Sample'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 12, 0, 0)'}),
