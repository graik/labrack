...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlasmidSample.plasmid_sequenced'
        db.add_column('labrack_plasmidsample', 'plasmid_sequenced',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlasmidSample.plasmid_sequenced'
        db.delete_column('labrack_plasmidsample', 'plasmid_sequenced')
