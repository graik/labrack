...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlasmidSample.is_vector_backbone'
        db.add_column('labrack_plasmidsample', 'is_vector_backbone',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PlasmidSample.GenBankfile'
        db.add_column('labrack_plasmidsample', 'GenBankfile',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlasmidSample.sequence_text'
        db.add_column('labrack_plasmidsample', 'sequence_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlasmidSample.is_vector_backbone'
        db.delete_column('labrack_plasmidsample', 'is_vector_backbone')

        # Deleting field 'PlasmidSample.GenBankfile'
        db.delete_column('labrack_plasmidsample', 'GenBankfile')

        # Deleting field 'PlasmidSample.sequence_text'
        db.delete_column('labrack_plasmidsample', 'sequence_text')
    ...
    models = {
        ...
        'labrack.plasmidsample': {
            ...
            'is_vector_backbone': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
