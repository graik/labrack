...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('labrack_plasmidsample', 'plasmid_dnaConstruct',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='dna_Sample', null=True, to=orm['labrack.DnaComponent'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 8, 0, 0)'}),
