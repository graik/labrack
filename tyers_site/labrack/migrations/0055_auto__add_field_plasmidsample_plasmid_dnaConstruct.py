...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlasmidSample.plasmid_dnaConstruct'
        db.add_column('labrack_plasmidsample', 'plasmid_dnaConstruct',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dna_Sample', null=True, to=orm['labrack.DnaComponent']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlasmidSample.plasmid_dnaConstruct'
        db.delete_column('labrack_plasmidsample', 'plasmid_dnaConstruct_id')
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 29, 0, 0)'}),
