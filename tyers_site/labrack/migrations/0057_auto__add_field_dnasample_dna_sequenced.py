...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DnaSample.dna_sequenced'
        db.add_column('labrack_dnasample', 'dna_sequenced',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DnaSample.dna_sequenced'
        db.delete_column('labrack_dnasample', 'dna_sequenced')
