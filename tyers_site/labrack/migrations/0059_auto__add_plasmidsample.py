...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('labrack_plasmidsample', (
            ...
            ('plasmid_dnaConstruct', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dna_Sample', null=True, to=orm['labrack.DnaComponent'])),
            ('plasmid_inChassis', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='chassis_Sample', null=True, to=orm['labrack.Chassis'])),
            ('plasmid_derivedFrom', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='derivedFromSample', null=True, to=orm['labrack.PlasmidSample'])),
            ('plasmid_provenanceType', self.gf('django.db.models.fields.CharField')(default='', max_length=30, null=True, blank=True)),
            ('plasmid_sequenced', self.gf('django.db.models.fields.CharField')(default='', max_length=30, null=True, blank=True)),
            ('plasmid_cloning_method', self.gf('django.db.models.fields.CharField')(default='', max_length=30, null=True, blank=True)),
            ('GenBankfile', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('sequence_text', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
    ...
    models = {
        ...
        'labrack.plasmidsample': {
            ...
            'sample_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['labrack.Sample']", 'unique': 'True', 'primary_key': 'True'}),
            'sequence_text': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 31, 0, 0)'}),
