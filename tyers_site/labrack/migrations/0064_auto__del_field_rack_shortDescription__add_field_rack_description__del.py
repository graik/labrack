...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Rack.shortDescription'
        db.delete_column('labrack_rack', 'shortDescription')

        # Adding field 'Rack.description'
        db.add_column('labrack_rack', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'Location.shortDescription'
        db.delete_column('labrack_location', 'shortDescription')

        # Adding field 'Location.description'
        db.add_column('labrack_location', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Rack.shortDescription'
        db.add_column('labrack_rack', 'shortDescription',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'Rack.description'
        db.delete_column('labrack_rack', 'description')

        # Adding field 'Location.shortDescription'
        db.add_column('labrack_location', 'shortDescription',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'Location.description'
        db.delete_column('labrack_location', 'description')
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 14, 0, 0)'}),
