...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('labrack_plasmidsample', (
            ...
            ('plasmid_derivedFrom', self.gf('django.db.models.fields.related.ForeignKey')(related_name='derivedFromSample', null=True, to=orm['labrack.PlasmidSample'], blank=True)),
            ('plasmid_dnaConstruct', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dna_Sample', null=True, to=orm['labrack.DnaComponent'], blank=True)),
            ('sequence_text', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('plasmid_inChassis', self.gf('django.db.models.fields.related.ForeignKey')(related_name='chassis_Sample', null=True, to=orm['labrack.Chassis'], blank=True)),
    ...
    models = {
        ...
        'labrack.sample': {
            ...
            'preparation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 22, 0, 0)'}),
