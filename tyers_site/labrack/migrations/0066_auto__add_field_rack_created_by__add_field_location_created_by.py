...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rack.created_by'
        db.add_column('labrack_rack', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='rack_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)
        ...
        db.add_column('labrack_location', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='location_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Rack.created_by'
        db.delete_column('labrack_rack', 'created_by_id')
        ...
        db.delete_column('labrack_location', 'created_by_id')
