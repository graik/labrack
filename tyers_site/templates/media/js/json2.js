          ...
          <div class="select-menu-list js-filter-tab js-filter-branches" data-filterable-for="commitish-filter-field" data-filterable-type="substring">
              ...
              <div class="select-menu-item js-navigation-item js-navigation-target selected">
                <span class="select-menu-checkmark mini-icon mini-icon-confirm"></span>
                    ...
                    <a href="/douglascrockford/JSON-js/blob/master/json2.js" class="js-navigation-open select-menu-item-text js-select-button-text" data-name="master" rel="nofollow">master</a>
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                ...
                <li><a href="/douglascrockford/JSON-js/raw/master/json2.js" class="button minibutton grouped-button bigger lighter" id="raw-url">Raw</a></li>
                  <li><a href="/douglascrockford/JSON-js/blame/master/json2.js" class="button minibutton grouped-button bigger lighter">Blame</a></li>
                <li><a href="/douglascrockford/JSON-js/commits/master/json2.js" class="button minibutton grouped-button bigger lighter" rel="nofollow">History</a></li>
              </ul>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.04714s from fe16.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.04833' data-host='fe16'></span>
